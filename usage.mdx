...
<Warning>
    ...
    The standard API should not be used in client-side scripts (e.g., jQuery, JavaScript) as it would expose sensitive API credentials, allowing unauthorized access to your account.
</Warning>
...
| /verify/batch                          | 50 per hour         |
| /verify/file                           | 50 per hour         |
