---
title: 'Widget'
description: 'Documentation of JavaScript Widget'
---
...
...
    ...
    <script type="text/javascript" src="https://cdn.proofy.com/widget/dist/Proofy.js"></script>
</body>
</html>
```


Once the snippet is added to your site, the widget will automatically detect any input elements using the email type or named "email." For fields not using the email type, you can enforce detection by adding the data-nb attribute. All three fields below would be recognized by the widget:
...
<input type="text" name="email_field" data-proofy />
```
...
Setting throttling rules helps you stop users from misusing your forms. You can set different rules to control how many times someone can check things within a certain time, either for specific IP addresses or for everyone. If someone tries too many times, the widget will treat it as unknown, so it doesn't stop the process.
